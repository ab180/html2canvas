...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var renderElement = function (element, opts) { return __awaiter(void 0, void 0, void 0, function () {
        var ownerDocument, defaultView, resourceOptions, contextOptions, windowOptions, windowBounds, context, foreignObjectRendering, cloneOptions, documentCloner, clonedElement, container, _a, width, height, left, top, backgroundColor, renderOptions, tickWrapper, tickContainer, tickElements, standardWidth, editFontElement, canvas, renderer, root, renderer;
            ...
            switch (_u.label) {
                ...
                case 1:
                    ...
                    if (opts.scrollPositions) {
                        Object.keys(opts.scrollPositions).forEach(function (className) {
                            var _a = opts.scrollPositions[className], x = _a.x, y = _a.y;
                            var target = clonedElement.querySelector(className);
                            if (target) {
                                target.scrollLeft = x;
                                target.scrollTop = y;
                            }
                    ...
                    tickWrapper = clonedElement.querySelectorAll('.recharts-wrapper');
                    tickContainer = clonedElement.querySelectorAll('.recharts-surface');
                    tickElements = clonedElement.querySelectorAll('.recharts-cartesian-grid-horizontal');
                    standardWidth = windowOptions.windowWidth;
                    if (opts.fullScreen) {
                        tickWrapper.forEach(function (item, index) {
                            if (tickWrapper.length / 2 <= index) {
                                var itemStyle = item.getAttribute('style');
                                item.setAttribute('style', itemStyle + " width: fit-content;");
                            }
                        });
                        tickContainer.forEach(function (item, index) {
                            if (tickContainer.length / 2 <= index) {
                                var itemStyle = item.getAttribute('style');
                                var itemAttr = item.getAttribute('viewBox').split(' ');
                                var result = itemAttr
                        ...
                        tickElements.forEach(function (item) {
                            var tick = item.querySelectorAll('line');
                            tick.forEach(function (tickItem) {
